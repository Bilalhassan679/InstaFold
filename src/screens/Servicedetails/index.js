        ...
        <TextComponent text={items.name} styles={styles.name} />
            ...
            <View style={{padding: 10}}>
              ...
              <View style={styles.star}>
                <TextComponent numberOfLines={3} text={'You’re almost done! Share a few details to prepare your Contractor for the job.'} styles={styles.des} />
              </View>
            </View>
          ...
          <Divider dividerStyle={{width: wp('100')}} />
            ...
            <ButtonComponent onPress={()=>navigation.navigate('ReviewScreen',{items})} text={'Review & Confirm'}/>
            </View>
      </>
  )
}
